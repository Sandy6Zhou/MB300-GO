...
typedef struct {
    __RW __u32 CON[15]; // 0-3 used in br52
    __RO __u32 REV0;
    __RW __u32 CID[15]; // 0-3 used in br52
    __RO __u32 REV1;
    __RW __u32 BEG[15]; // 0-3 used in br52
    __RO __u32 REV2;
    __RW __u32 END[15]; // 0-3 used in br52
    __RW __u32 WREN;
} JL_MPU_TypeDef;
...
typedef struct {
    ...
    /* 33 */  __RW __u32 TSEVT;
    /*    */  __RO __u32 REV30[0x37 - 0x33 - 1];
    /* 37 */  __RW __u32 NSC_CON0;
    /* 38 */  __RW __u32 NSC_ADRH;
    /* 39 */  __RW __u32 NSC_ADRL;
    /* 3a */  __RO __u32 NSC_NS;
