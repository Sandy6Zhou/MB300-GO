...
#define P3_ANA_FLOW4                  P33_ACCESS(0x044)
#define P3_ANA_FLOW5                  P33_ACCESS(0x045)
...
#define P3_ANA_KEEP4                  P33_ACCESS(0x04c)
#define P3_ANA_KEEP5                  P33_ACCESS(0x04d)
...
#define P3_PMU_ADC2                   P33_ACCESS(0x057)
#define P3_VBG_CON0                   P33_ACCESS(0x058)
#define P3_VBG_CON1                   P33_ACCESS(0x059)
#define P3_IOV_CON0                   P33_ACCESS(0x05a)
#define P3_IOV_CON1                   P33_ACCESS(0x05b)
#define P3_PAVD_CON0                  P33_ACCESS(0x05c)
#define P3_PVD_CON0                   P33_ACCESS(0x05d)
#define P3_WVD_CON0                   P33_ACCESS(0x05e)
#define P3_EVD_CON0                   P33_ACCESS(0x05f)
...
#define P3_CHG_CON5                   P33_ACCESS(0x075)
...
#define P3_VDET_CON0                  P33_ACCESS(0x0f0)
#define P3_VDET_CON1                  P33_ACCESS(0x0f1)
#define P3_VDET_CNT0                  P33_ACCESS(0x0f2)
...
#define P3_IWKUP_FLT_EN               P33_ACCESS(0x128)
#define P3_IWKUP_P_IE                 P33_ACCESS(0x129)
#define P3_IWKUP_N_IE                 P33_ACCESS(0x12a)
#define P3_IWKUP_LEVEL                P33_ACCESS(0x12b)
#define P3_IWKUP_P_PND                P33_ACCESS(0x12c)
#define P3_IWKUP_N_PND                P33_ACCESS(0x12d)
#define P3_IWKUP_P_CPND               P33_ACCESS(0x12e)
#define P3_IWKUP_N_CPND               P33_ACCESS(0x12f)
...
#define P3_WKUP_CLK_SEL               P33_ACCESS(0x136)
#define P3_AWKUP_CLK_SEL              P33_ACCESS(0x137)
#define P3_IWKUP_CLK_SEL0             P33_ACCESS(0x138)
#define P3_IWKUP_CLK_SEL1             P33_ACCESS(0x139)
#define P3_IWKUP_CLK_SEL2             P33_ACCESS(0x13a)
#define P3_IWKUP_CLK_SEL3             P33_ACCESS(0x13b)
#define P3_IWKUP_CLK_SEL4             P33_ACCESS(0x13c)
#define P3_IWKUP_CLK_SEL5             P33_ACCESS(0x13d)
#define P3_IWKUP_CLK_SEL6             P33_ACCESS(0x13e)
#define P3_IWKUP_CLK_SEL7             P33_ACCESS(0x13f)
...
#define P3_LS_CTMU                    P33_ACCESS(0x1a3)
#define P3_LS_PLL                     P33_ACCESS(0x1a4)
#define P3_LS_BTOSC                   P33_ACCESS(0x1a5)
