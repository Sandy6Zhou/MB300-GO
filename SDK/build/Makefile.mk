...
c_SRC_FILES := \
	...
	apps/soundbox/board/br28/board_config.c \
...
LFLAGS := \
	...
	cpu/br28/liba/lib_speex_codec.a \
	...
	cpu/br28/liba/lib_opus_stenc.a \
	...
	cpu/br28/liba/lib_ogg_vorbis_dec.a \
	...
	cpu/br28/liba/lib_HowlingGate.a \
	...
	cpu/br28/liba/lib_PingPongDelay.a \
	...
	cpu/br28/liba/spectrum.a \
	cpu/br28/liba/lib_StereoMtapsEcho.a \
	cpu/br28/liba/lib_DistortionEXP.a \
	...
	cpu/br28/liba/lib_jla_ll_codec.a \
	cpu/br28/liba/lib_jlalw_codec.a \
	...
	cpu/br28/liba/lwip_2_2_0.a \
	cpu/br28/liba/mbedtls_3_4_0.a \
	cpu/br28/liba/websocket.a \
	cpu/br28/liba/http_cli.a \
	cpu/br28/liba/libmpeg.a \
	cpu/br28/liba/network_download.a \
...
pre_build:
	$(info +PRE-BUILD)
	$(QUITE) $(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -DEXPORT_PLATFORM_HW_MATH_VERSION=2 -DEXPORT_PLATFORM_AUDIO_TDM_ENABLE=0 -DEXPORT_PLATFORM_AUDIO_FM_ENABLE=1 -DEXPORT_PLATFORM_ANC_ENABLE=0 -DEXPORT_PLATFORM_AUDIO_ALINK_ENABLE=1 -DEXPORT_PLATFORM_AUDIO_SPATIAL_EFFECT_ENABLE=1 -DEXPORT_PLATFORM_AUDIO_SMART_VOICE_ENABLE=1 -DEXPORT_PLATFORM_AUDIO_UART_SENDER_ENABLE=1 -DEXPORT_LE_AUDIO_SUPPORT=1 -DEXPORT_PLATFORM_AUDIO_WM8978_ENABLE=1 -D__LD__ -DEXPORT_SOMATOSENSORY_ENABLE=0 -DEXPORT_PLATFORM_AUDIO_SPDIF_ENABLE=0 -DEXPORT_PLATFORM_ICSD_ENABLE=0 -DEXPORT_PLATFORM_AUDIO_EFFECT_DEMO_ENABLE=1 -DEXPORT_PLATFORM_AUDIO_PDM_ENABLE=1 -E -P build/genFileList.c -o build/fileList.dumy
	$(QUITE) $(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -DEXPORT_PLATFORM_HW_MATH_VERSION=2 -DEXPORT_PLATFORM_AUDIO_TDM_ENABLE=0 -DEXPORT_PLATFORM_AUDIO_FM_ENABLE=1 -DEXPORT_PLATFORM_ANC_ENABLE=0 -DEXPORT_PLATFORM_AUDIO_ALINK_ENABLE=1 -DEXPORT_PLATFORM_AUDIO_SPATIAL_EFFECT_ENABLE=1 -DEXPORT_PLATFORM_AUDIO_SMART_VOICE_ENABLE=1 -DEXPORT_PLATFORM_AUDIO_UART_SENDER_ENABLE=1 -DEXPORT_LE_AUDIO_SUPPORT=1 -DEXPORT_PLATFORM_AUDIO_WM8978_ENABLE=1 -D__LD__ -DEXPORT_SOMATOSENSORY_ENABLE=0 -DEXPORT_PLATFORM_AUDIO_SPDIF_ENABLE=0 -DEXPORT_PLATFORM_ICSD_ENABLE=0 -DEXPORT_PLATFORM_AUDIO_EFFECT_DEMO_ENABLE=1 -DEXPORT_PLATFORM_AUDIO_PDM_ENABLE=1 -E -P build/fileList.c -o build/fileList.mk
	$(QUITE) $(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -DEXPORT_PLATFORM_HW_MATH_VERSION=2 -DEXPORT_PLATFORM_AUDIO_TDM_ENABLE=0 -DEXPORT_PLATFORM_AUDIO_FM_ENABLE=1 -DEXPORT_PLATFORM_ANC_ENABLE=0 -DEXPORT_PLATFORM_AUDIO_ALINK_ENABLE=1 -DEXPORT_PLATFORM_AUDIO_SPATIAL_EFFECT_ENABLE=1 -DEXPORT_PLATFORM_AUDIO_SMART_VOICE_ENABLE=1 -DEXPORT_PLATFORM_AUDIO_UART_SENDER_ENABLE=1 -DEXPORT_LE_AUDIO_SUPPORT=1 -DEXPORT_PLATFORM_AUDIO_WM8978_ENABLE=1 -D__LD__ -DEXPORT_SOMATOSENSORY_ENABLE=0 -DEXPORT_PLATFORM_AUDIO_SPDIF_ENABLE=0 -DEXPORT_PLATFORM_ICSD_ENABLE=0 -DEXPORT_PLATFORM_AUDIO_EFFECT_DEMO_ENABLE=1 -DEXPORT_PLATFORM_AUDIO_PDM_ENABLE=1 -E -P apps/soundbox/sdk_used_list.c -o apps/soundbox/sdk_used_list.used
	$(QUITE) $(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -DEXPORT_PLATFORM_HW_MATH_VERSION=2 -DEXPORT_PLATFORM_AUDIO_TDM_ENABLE=0 -DEXPORT_PLATFORM_AUDIO_FM_ENABLE=1 -DEXPORT_PLATFORM_ANC_ENABLE=0 -DEXPORT_PLATFORM_AUDIO_ALINK_ENABLE=1 -DEXPORT_PLATFORM_AUDIO_SPATIAL_EFFECT_ENABLE=1 -DEXPORT_PLATFORM_AUDIO_SMART_VOICE_ENABLE=1 -DEXPORT_PLATFORM_AUDIO_UART_SENDER_ENABLE=1 -DEXPORT_LE_AUDIO_SUPPORT=1 -DEXPORT_PLATFORM_AUDIO_WM8978_ENABLE=1 -D__LD__ -DEXPORT_SOMATOSENSORY_ENABLE=0 -DEXPORT_PLATFORM_AUDIO_SPDIF_ENABLE=0 -DEXPORT_PLATFORM_ICSD_ENABLE=0 -DEXPORT_PLATFORM_AUDIO_EFFECT_DEMO_ENABLE=1 -DEXPORT_PLATFORM_AUDIO_PDM_ENABLE=1 -E -P apps/soundbox/movable/section.c -o apps/soundbox/movable/section.txt
	$(QUITE) $(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -DEXPORT_PLATFORM_HW_MATH_VERSION=2 -DEXPORT_PLATFORM_AUDIO_TDM_ENABLE=0 -DEXPORT_PLATFORM_AUDIO_FM_ENABLE=1 -DEXPORT_PLATFORM_ANC_ENABLE=0 -DEXPORT_PLATFORM_AUDIO_ALINK_ENABLE=1 -DEXPORT_PLATFORM_AUDIO_SPATIAL_EFFECT_ENABLE=1 -DEXPORT_PLATFORM_AUDIO_SMART_VOICE_ENABLE=1 -DEXPORT_PLATFORM_AUDIO_UART_SENDER_ENABLE=1 -DEXPORT_LE_AUDIO_SUPPORT=1 -DEXPORT_PLATFORM_AUDIO_WM8978_ENABLE=1 -D__LD__ -DEXPORT_SOMATOSENSORY_ENABLE=0 -DEXPORT_PLATFORM_AUDIO_SPDIF_ENABLE=0 -DEXPORT_PLATFORM_ICSD_ENABLE=0 -DEXPORT_PLATFORM_AUDIO_EFFECT_DEMO_ENABLE=1 -DEXPORT_PLATFORM_AUDIO_PDM_ENABLE=1 -E -P cpu/br28/sdk_ld.c -o cpu/br28/sdk.ld
	$(QUITE) $(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -DEXPORT_PLATFORM_HW_MATH_VERSION=2 -DEXPORT_PLATFORM_AUDIO_TDM_ENABLE=0 -DEXPORT_PLATFORM_AUDIO_FM_ENABLE=1 -DEXPORT_PLATFORM_ANC_ENABLE=0 -DEXPORT_PLATFORM_AUDIO_ALINK_ENABLE=1 -DEXPORT_PLATFORM_AUDIO_SPATIAL_EFFECT_ENABLE=1 -DEXPORT_PLATFORM_AUDIO_SMART_VOICE_ENABLE=1 -DEXPORT_PLATFORM_AUDIO_UART_SENDER_ENABLE=1 -DEXPORT_LE_AUDIO_SUPPORT=1 -DEXPORT_PLATFORM_AUDIO_WM8978_ENABLE=1 -D__LD__ -DEXPORT_SOMATOSENSORY_ENABLE=0 -DEXPORT_PLATFORM_AUDIO_SPDIF_ENABLE=0 -DEXPORT_PLATFORM_ICSD_ENABLE=0 -DEXPORT_PLATFORM_AUDIO_EFFECT_DEMO_ENABLE=1 -DEXPORT_PLATFORM_AUDIO_PDM_ENABLE=1 -E -P cpu/br28/tools/download.c -o $(POST_SCRIPT)
	$(QUITE) $(FIXBAT) $(POST_SCRIPT)
	$(QUITE) $(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -DEXPORT_PLATFORM_HW_MATH_VERSION=2 -DEXPORT_PLATFORM_AUDIO_TDM_ENABLE=0 -DEXPORT_PLATFORM_AUDIO_FM_ENABLE=1 -DEXPORT_PLATFORM_ANC_ENABLE=0 -DEXPORT_PLATFORM_AUDIO_ALINK_ENABLE=1 -DEXPORT_PLATFORM_AUDIO_SPATIAL_EFFECT_ENABLE=1 -DEXPORT_PLATFORM_AUDIO_SMART_VOICE_ENABLE=1 -DEXPORT_PLATFORM_AUDIO_UART_SENDER_ENABLE=1 -DEXPORT_LE_AUDIO_SUPPORT=1 -DEXPORT_PLATFORM_AUDIO_WM8978_ENABLE=1 -D__LD__ -DEXPORT_SOMATOSENSORY_ENABLE=0 -DEXPORT_PLATFORM_AUDIO_SPDIF_ENABLE=0 -DEXPORT_PLATFORM_ICSD_ENABLE=0 -DEXPORT_PLATFORM_AUDIO_EFFECT_DEMO_ENABLE=1 -DEXPORT_PLATFORM_AUDIO_PDM_ENABLE=1 -E -P cpu/br28/tools/isd_config_rule.c -o cpu/br28/tools/isd_config.ini
